...
// license information.
//#include "..\..\M5GFX\src\lgfx\v1\panel\Panel_SSD1306.hpp"
//#include "..\..\..\..\..\src\lgfx.h"
#include "..\..\..\.pio\libdeps\m5stack-nanoc6\M5GFX\src\lgfx\v1\panel\Panel_SSD1306.hpp"
#include "..\..\..\src\lgfx.h"
#include "Face.h"
...
//           new M5Canvas(&M5.Lcd), new M5Canvas(&M5.Lcd)) {}
           new M5Canvas((LovyanGFX *)&lcd), new M5Canvas((LovyanGFX *)&lcd)) {}
...
// ▼▼▼▼ここから▼▼▼▼
  ...
  if (tmpSprite->getBuffer() == nullptr) {
    ...
    tmpSprite->setColorDepth(lcd.getColorDepth());
...
//    tmpSprite->pushSprite(&lcd, boundingRect->getLeft(), boundingRect->getTop() + y);
    tmpSprite->pushSprite((LovyanGFX *)&lcd, boundingRect->getLeft(), boundingRect->getTop() + y);
